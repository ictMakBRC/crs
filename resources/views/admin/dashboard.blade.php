                        ...
                        <div class="col-sm-6 col-xl-4">
                            <div class="card shadow-none m-0 border-start">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span>{{$facilities->count()}}</span></h3>
                                    <p class="text-muted font-15 mb-0">Facilities</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-xl-4">
                            <div class="card shadow-none m-0 border-start">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span>{{$logs->count()}}</span></h3>
                                    <p class="text-muted font-15 mb-0">Logs</p>
                            ...
                            <table id="datableButtons" class="table w-100 nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$user->title}}</td>
                                        <td>{{$user->name}}</td>
                                        <td>{{$user->facility->facility_name}}{{$user->facility->parent!=null?' ('.$user->facility->parent->facility_name.')':''}}</td>
