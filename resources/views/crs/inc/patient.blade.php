...
<div class="mb-3 col-md-3 d-none">
    ...
    <input type='file' accept="image/*" disabled capture="environment"class="dropify form-control" required
        id="patient_photo" name="patient_photo" />
</div>
<div class="mb-3 col-md-3 d-none">
    <label for="tube_photo" class="form-label">Test Tube Image<span class="text-danger">*</span></label>
    <input type='file' disabled accept="image/*" capture="environment"class="dropify form-control" required
        name="tube_photo" id="tube_photo" />
</div>

<div class="mb-3 col-md-3">
    <label for="patient_id" class="form-label">Patient ID</label>
    <input type="text" id="patient_id" class="form-control text-uppercase"
        onkeyup="this.value = this.value.toUpperCase();" name="patient_id" value="{{ old('patient_id', '') }}">
</div>
<div class="mb-3 col-md-3">
    <label for="surname" class="form-label">Surname<span class="text-danger">*</span></label>
    <input type="text" id="surname" class="form-control text-uppercase"
        onkeyup="this.value = this.value.toUpperCase();" name="surname" required value="{{ old('surname', '') }}">
</div>
<div class="mb-3 col-md-3">
    <label for="given_name" class="form-label">Given Name<span class="text-danger">*</span></label>
    <input type="text" id="given_name" class="form-control text-uppercase"
        onkeyup="this.value = this.value.toUpperCase();" name="given_name" required value="{{ old('given_name', '') }}">
</div>
<div class="mb-3 col-md-3">
    <label for="other_name" class="form-label">Other Name</label>
    <input type="text" id="other_name" class="form-control text-uppercase"
        onkeyup="this.value = this.value.toUpperCase();" name="other_name" value="{{ old('other_name', '') }}">
</div>
<div class="mb-3 col-md-3">
...
<div class="mb-3 col-md-3">
    ...
    <input type="text" id="doc_no" class="form-control text-uppercase"
        onkeyup="this.value = this.value.toUpperCase();" name="doc_no" value="{{ old('doc_no', '') }}">
</div>
<div class="mb-3 col-md-3">
    <label for="patient_email" class="form-label">Email</label>
    <input type="email" id="patient_email" class="form-control" name="patient_email"
...
<div class="mb-3 col-md-3">
    ...
    <input type="tel" id="phone_number" class="form-control" name="phone_number"
        value="{{ old('phone_number', '') }}" pattern="[1-9]{1,3}[0-9]{1,4}[0-9]{6}" minlength="12" required
        placeholder="like 256715660055">
</div>

<div class="mb-3 col-md-3">
    <label for="nok_name" class="form-label">Next of Kin</label>
    <input type="text" id="nok_name" class="form-control text-uppercase"
        onkeyup="this.value = this.value.toUpperCase();" name="nok_name" value="{{ old('nok_name', '') }}">
</div>
...
<div class="mb-3 col-md-3">
    ...
    @endphp
    <label for="collection_date" class="form-label">Collection Date(Time in 24hrs)<span
            class="text-danger">*</span></label>
    <input type="datetime-local" id="collection_date" class="form-control" name="collection_date"
        max="{{ date('Y-m-d\TH:i:s', strtotime($maxCollect)) }}" required value="{{ old('collection_date', '') }}">
</div>
<div class="mb-3 col-md-3">
...
<div class="mb-3 col-md-3">
    <div class="form-group">
        ...
        <select name="ever_been_vaccinated" id="ever_been_vaccinated" onchange="vaccinated()" class="form-select"
