<x-crs-layout>
    ...
    <div class="row mx-auto">
        <ul class="nav nav-tabs nav-bordered mb-3">
            <li class="nav-item">
                <a href="#filterPatientList" data-bs-toggle="tab" aria-expanded="false" class="nav-link active">
                    <i class="mdi mdi-home-variant d-md-none d-block"></i>
                    <span class="d-none d-md-block">List</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="#filterPatientCount" data-bs-toggle="tab" aria-expanded="true" class="nav-link">
                    <i class="mdi mdi-account-circle d-md-none d-block"></i>
                    <span class="d-none d-md-block">Counts</span>
                </a>
            </li>
        ...
        <div class="tab-content">       
            <div class="tab-pane show active" id="filterPatientList">
                <div class="card">
                    <div class="card-body">
            ...
            <div class="tab-pane" id="filterPatientCount">
                <div class="card">
                    <div class="card-body">    
                        <form action="{{url('lab/report/filterCount')}}" method="POST">
                                @csrf
                                <div class="row">
                                    <h4>Filter Facility Patients List</h4>
                                <div class="mb-3 col-md-3">
