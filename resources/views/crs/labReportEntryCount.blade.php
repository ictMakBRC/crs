    ...
    <div class="row">
        <div class="col-12">
            <div class="row">
                ...
                <h5 style="text-align:center; font-family:times; color:rgb(34, 33, 33)"><b>All User Entry Count Between <span class="text-success">{{$from}}</span> And <span class="text-success">{{$to}}</span> Facility (<span class="text-success">{{$user}}</span>)</b></h5>
