        ...
        <div class="col-md-12">
            <div class="mb-6 col-md-3">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="{{route('patientRegmean')}}" type="button" class="btn btn-secondary">Mean</a>
                    <a href="{{route('patientRegRange')}}" type="button" class="btn btn-secondary">Range</a>
                    <a href="{{route('patientRegPropotion')}}" class="btn btn-secondary">Propotion</a>
                  </div>
            </div>
        </div>
    </div>
