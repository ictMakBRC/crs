                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" id="password" class="form-control" autocomplete="off" pattern="(?=.*[!@#$%^&*_=+-])(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number, one uppercase, one lowercase letter, one special symbol and at least 8 or more characters " name="password">
                            </div>
                            <div class="mb-3">
                                <label for="password_confirmation" class="form-label">Confirm New Password</label>
                                <input type="password" id="password_confirmation" class="form-control" autocomplete="off" pattern="(?=.*[!@#$%^&*_=+-])(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number, one uppercase, one lowercase letter, one special symbol and at least 8 or more characters " name="password_confirmation">
                            </div>
