                ...
                <div class="pl-9 card-body">
                    <ul class="nav nav-pills nav-justified form-wizard-header mb-3">
                        <li class="nav-item">
                            <a href="#account-2" data-bs-toggle="tab" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2 active">
                                ...
                                <span class="d-none d-sm-inline">Update {{ $value->surname }}  {{ $value->given_name }} (Patient: {{ $value->lab_no?$value->lab_no:$value->patient_id }}) Information</span>
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content b-0 mb-0">
                        ...
                        <div class="tab-pane active" id="account-2">
                            <form method="POST" action="{{url('admin/lab/update/'.$value->wid)}}" class="" >
                                @csrf
                                <div class="row">
